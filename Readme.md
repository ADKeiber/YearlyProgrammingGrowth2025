# Yearly Programming Growth 2025
...
| 01/22/2025 | Assembly Exploration [here](https://github.com/ADKeiber/AssemblyExploration/tree/main/OS)<br>Assembly tutorial from OliveStem [30/48](https://www.youtube.com/watch?v=wI6MYewlZpA&list=PL2EF13wm-hWCoj6tUBGUmrkJmH1972dBB&index=30)<br>Assembly tutorial from OliveStem [31/48](https://www.youtube.com/watch?v=zHJ2vlBnNr0&list=PL2EF13wm-hWCoj6tUBGUmrkJmH1972dBB&index=31) |
...
| 01/26/2025 | Start Django [tutorial 2](https://docs.djangoproject.com/en/5.1/intro/tutorial02/)<br> Start Django [tutorial 3](https://docs.djangoproject.com/en/5.1/intro/tutorial03/)<br>Python Tutorial [here](https://github.com/ADKeiber/djangotutorial) |
| 01/27/2025 | Start Django [tutorial 4](https://docs.djangoproject.com/en/5.1/intro/tutorial04/)<br>Python Tutorial [here](https://github.com/ADKeiber/djangotutorial) |
...
| 02/09/2025 | 2/2 of the spring boot websocket [tutorial](https://spring.io/guides/gs/messaging-stomp-websocket)<br> Real Time Polling application [coding](https://github.com/ADKeiber/Real-Time-Polling-Application)<br> Install Golang and do [hello world](https://go.dev/doc/tutorial/getting-started)<br> Read go's [declaration-syntax](https://go.dev/blog/declaration-syntax)<br>Welcome to a tour of Go - [Welcome](https://go.dev/tour/welcome/1)<br>Welcome to a tour of Go - [Packages, variables, and functions](https://go.dev/tour/basics/1)<br>Welcome to a tour of Go - [Flow Control Statements- for, if else, switch and defer](https://go.dev/tour/flowcontrol/1)<br>Welcome to a tour of Go - [More types: structs, slices and maps](https://go.dev/tour/moretypes/1)|
...
| 02/24/2025 | Chapter 1 Of Full HTTP Networking Course [video](https://www.youtube.com/watch?v=2JYT5f2isg4)<br> Read [What is a URL](https://developer.mozilla.org/en-US/docs/Learn_web_development/Howto/Web_mechanics/What_is_a_URL) article <br> Boot.dev [CH1 HTTP](https://www.boot.dev/lessons/09ed0562-5760-4a78-919a-0233fa9b3227)|
...
| 03/03/2025 | Completed 'What is a Domain Name' node in roadmap.sh [backend map](https://roadmap.sh/backend)<br> A Beginners Guide to How Domain Names Work Youtube [video](https://www.youtube.com/watch?v=Y4cRx19nhJk) <br> Everything You Need to Know About Domain Names Youtube [video](https://www.youtube.com/watch?v=qO5qcQgiNX4)<br> What is a Domain Mozilla [article](https://developer.mozilla.org/en-US/docs/Learn_web_development/Howto/Web_mechanics/What_is_a_domain_name)<br> What is a domain name? Domain name vs. URL cloudfare [article](https://www.cloudflare.com/en-gb/learning/dns/glossary/what-is-a-domain-name/)|
| 03/04/2025| What is Web Hosting and How Does It Work? Youtube [video](https://www.youtube.com/watch?v=H8oAvyqQwew)<br> Different Types of Web Hosting Explained! Shared Hosting vs. VPS Hosting vs. Dedicated Server Youtube [video](https://www.youtube.com/watch?v=AXVZYzw8geg)<br>Where to Host a Fullstack Project on a Budget Youtube [video](https://www.youtube.com/watch?v=Kx_1NYYJS7Q)<br> What is a web server? mdn [article](https://developer.mozilla.org/en-US/docs/Learn_web_development/Howto/Web_mechanics/What_is_a_web_server) <br> Browsing the web mdn [article](https://developer.mozilla.org/en-US/docs/Learn_web_development/Getting_started/Environment_setup/Browsing_the_web) <br> Completed 'What is hosting' node in roadmap.sh [backend map](https://roadmap.sh/backend)|
...
| 03/31/2025 | Expense Tracker front-end [repo](https://github.com/ADKeiber/VueJSExploration/tree/main/ExpenseTracker)<br>AuthApp PHP rest API [repo](https://github.com/ADKeiber/PhpProjects)|
## March
| Date | Description |
| ----------- | ----------- |
| 04/01/2025 | AuthApp PHP rest API [repo](https://github.com/ADKeiber/PhpProjects) |
| 04/02/2025 | AuthApp PHP rest API [repo](https://github.com/ADKeiber/PhpProjects) |
...
| 04/05/2025 | AuthApp PHP rest API [repo](https://github.com/ADKeiber/PhpProjects) |
